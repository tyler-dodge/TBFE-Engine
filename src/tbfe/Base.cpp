...
namespace TBFE_Base
{
  ...
  Quaternion cameraAngle_(0,0,0,1);
  ...
  Quaternion getCameraAngle()
  {
    return cameraAngle_;
  };
  void setCameraAngle(Quaternion rotation)
  {
    cameraAngle_=rotation;
  };
  void rotateCamera(Quaternion rotation)
  {
    cameraAngle_=rotation*cameraAngle_;
  };

...
class Actor(_object):
    ...
    def getPositionD(*args): return _Actor.Actor_getPositionD(*args)
    def setPositionD(*args): return _Actor.Actor_setPositionD(*args)
    def getRotationD(*args): return _Actor.Actor_getRotationD(*args)
    def setRotationD(*args): return _Actor.Actor_setRotationD(*args)
